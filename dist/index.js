...
const throwPipelineVariableError = () => {
...
const webhook_1 = __nccwpck_require__(6246);
const url_1 = __nccwpck_require__(7310);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const inputs = (0, inputs_1.getInputs)();
            yield (0, exports.sendWebhookRequest)(inputs);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.buildWebhookUrl = exports.triggerWebhook = void 0;
const axios_1 = __importDefault(__nccwpck_require__(8757));
const url_1 = __nccwpck_require__(7310);
const triggerWebhook = (url, webhookToken) => __awaiter(void 0, void 0, void 0, function* () {
    const urlWithToken = new url_1.URL(url.toString());
    urlWithToken.searchParams.append('webhook_token', webhookToken);
    yield axios_1.default.post(urlWithToken.toString());
});
exports.triggerWebhook = triggerWebhook;
const buildWebhookUrl = (inputs) => {
    const url = new url_1.URL(inputs.concourseUrl);
